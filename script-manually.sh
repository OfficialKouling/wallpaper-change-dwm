#!/bin/bash
old_norm_fg=$(cat ~/.cache/wal/colors-wal-dwm.h | grep "norm_fg\[\]" | awk '{print $6}')
old_norm_bg=$(cat ~/.cache/wal/colors-wal-dwm.h | grep "norm_bg\[\]" | awk '{print $6}')
old_norm_border=$(cat ~/.cache/wal/colors-wal-dwm.h | grep "norm_border\[\]" | awk '{print $6}')
old_sel_bg=$(cat ~/.cache/wal/colors-wal-dwm.h | grep "sel_bg\[\]" | awk '{print $6}')
old_urg_bg=$(cat ~/.cache/wal/colors-wal-dwm.h | grep "urg_bg\[\]" | awk '{print $6}')
